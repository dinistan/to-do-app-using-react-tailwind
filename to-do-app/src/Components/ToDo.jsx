  ...
  return (
    <div className='bg-white place-self-center w-11/12 max-w-md flex-col p-7 min-h-[550px] rounded-xl'>
      ...
      <div className='flex items-center my-7 bg-gray-200 rounded-full'>
        <input ref={inputRef} className='bg-transparent bordder-0 outline-none flex-1 h-14 pl-6 pr-2 
        placeholder:text-slate-600' type='text' placeholder='Add your task'/>
        <button onClick={add} className='border-none rounded-full bg-red-500 w-32 h-14 text-white text-lg font-medium 
